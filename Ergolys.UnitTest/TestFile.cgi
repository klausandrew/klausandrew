...
<script	type="text/javascript">
 <!-- // <![CDATA[
    $(document).ready(function(){
        $("#shell").append("<div class='clearer'>&nbsp;</div>");
    });
 // ]]> -->
		...
		<div id="multiCol">
			<div id="contentLeft">
				<div class="c11text webwib">
				    ...
				    <div class="alert paragraphText">

							<img src="https://a248.e.akamai.net/f/248/3608/90m/online-static.wellsfargo.com/das/common/images/ico_alertInput.gif"	height="13" width="13" alt="Error" />
					     	&nbsp;<strong>Your browser is set to refuse cookies. In order to sign on, you will need to reset the option in your browser to accept cookies. Then refresh your screen, re-enter your username and password and click Sign On to begin banking.&nbsp;</strong>
...
<script type="text/javascript" src="/das/common/scripts/user-prefs.js"></script>
...
function collectPcPrint() {
	...
	return true;
			...
			<form action="https://online.wellsfargo.com/das/cgi-bin/session.cgi?screenid=SIGNON" method="post" name="Signon" id="Signon" autocomplete="off" onsubmit="return collectPcPrint()">
...
<noscript><!-- No alternative content --></noscript>
    ...
    <p class="footer2">
        &copy; 1999 - 2015 Wells Fargo. All rights reserved.
    </p>
    </div>
		...
		<script language="JavaScript" src="/das/common/scripts/mediaplexROI.js">
			</script>
				...
				<noscript>
					<img src="https://adfarm.mediaplex.com/ad/bk/7116-59391-3840-0?DMTDCCNFLLOGIN=1&mpt="
